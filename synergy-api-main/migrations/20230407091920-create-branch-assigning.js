...
module.exports = {
  async up (queryInterface, Sequelize) {
     await queryInterface.createTable("sc_branch_assignings", {
      id: {
      ...
      companyCountryId:{
        type: Sequelize.INTEGER, //company country id from sa_company_country table
        allowNull: false,
      },
      employeeRole: {
  ...
  async down (queryInterface, Sequelize) {
     await queryInterface.dropTable('sc_branch_assignings');
  }
};
